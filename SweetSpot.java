...
public class SweetSpot extends AppCompatActivity {
    private static final String TAG_ACTIVITY = "SweetSpot";
    ...
    private void addMenuItems() {
        ...
        iadapter = new ItemListAdapter(SweetSpot.this, mitemlist);
    ...
    public void dmenu(View v) {
        startActivity(new Intent(SweetSpot.this, Dmenu.class));
    }
    ...
    private void inflateActionBar() {
        ...
        textviewTitle.setText("The Sweet Spot");
